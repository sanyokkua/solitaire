...
- [ ] 1.1 Implement the shared domain types, the card identity encoding and the domain purity guard
    - **Implements:**
...
- [ ] 1.2 Implement the seeded generator, the fresh-seed source and the unbiased shuffle
...
- [ ] 2.1 Implement the seeded deal, the starting score and the shared test fixtures
    - **Implements:**
...
- [ ] 2.2 Implement deal-code encoding and decoding
...
- [ ] 3.1 Implement pile accessors and movable groups
...
- [ ] 3.2 Implement legal drop targets and the canonical destination order
...
- [ ] 3.3 Implement pass limits, recycle permission and win detection
...
- [ ] 4.1 Implement the event score deltas for Standard and Vegas, including the three-card recycle penalty
...
- [ ] 4.2 Implement the time penalty, win bonus, undo cost and displayed score
...
- [ ] 5.1 Implement `applyCommand` for `move`, `autoFoundation` and `draw`
...
- [ ] 6.1 Implement the safe-move rule and the next safe move
...
- [ ] 6.2 Implement the hint heuristic and dead-end detection
...
- [ ] 6.3 Implement the smart-tap target choice
...
- [ ] 6.5 Add the recorded winning line (phase gate)
...
- [ ] 7.1 Measure coverage over every source file and assert the domain module inventory
...
- [ ] 7.2 Align the specification pack and agent docs with the engine
